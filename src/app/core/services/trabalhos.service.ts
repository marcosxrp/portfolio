...
export class TrabalhosService {
  ...
  trabalhos = signal<Trabalho[]>([
    ...
    {id: 4, nome: 'Anime Parade', descricao: 'Um site sobre curiosidades do mundo dos animes, está aqui para demonstrar minhas capacidades com o javascript puro', imagem: 'assets/anime-parade-01.PNG', paginaWeb: 'https://anime-parade.netlify.app', paginaDocumentacao: 'https://github.com/marcosxrp/Projeto-conclusao-web', tags: ['css', 'javascript', 'html']}
  ]);
